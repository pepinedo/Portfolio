    ...
    return(
        <section className='redes-sociales'>
			<a href="https://github.com/pepinedo" target='_blank' rel="noopener noreferrer">
				<img src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/github/github-original.svg" alt="Icono de Github" />
			</a>
			<a href="https://www.linkedin.com/in/pedro-pinedo-cobo/" target='_blank' rel="noopener noreferrer">
				<img src="Portfolio/images/icons/linkedin.png" alt="Icono de Linkedin" />
			</a>
		</section>
    )
}